...
The detailed project brief will be published later. This page fixes the framework.

## Purpose

The project is the course's synthesis: a full data-analysis workflow from raw measurements to a decision.

You should be able to:

- formulate an engineering question that data can answer;
- collect or import data and carry out relevant preprocessing;
- select methods from across the course (descriptive analysis, intervals, tests, ANOVA, regression, or categorical methods);
...
Until the brief appears, use these defaults:
