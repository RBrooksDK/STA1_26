...
Synthetic files are generated by `tools/generate_datasets.py` with seed `2026`. True parameters are stored in `data/generation_log.json` for the lecturer; students should analyse the CSV files as if the parameters were unknown.
