...
A goodness-of-fit test asks whether one set of counts matches a claimed distribution. A test of independence asks whether two classifications are associated. Expected counts should not be too small, and standardised residuals show which cells drive a significant result. The conclusion is stated in terms of the engineering categories, not only \(\chi^2\).
...
!!! tip "Learning Objectives"
    ...
    - Perform a goodness-of-fit test and a test of independence.
    - Check the guideline that expected counts should not be too small.
    - Interpret standardised residuals.
